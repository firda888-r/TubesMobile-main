  ...
  return (
    <div className="min-h-screen bg-[#f7f1e8] pt-20 pb-24 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="bg-[#ED8B3C] p-6 text-white text-center">
          <h1 className="text-2xl font-bold">Lapor Rescue</h1>
          <p className="text-orange-100 text-sm">Bantu kucing terlantar mendapatkan pertolongan.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="relative w-full h-48 bg-gray-100 rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center overflow-hidden">
              {preview ? (
                <img src={preview} alt="Preview" className="w-full h-full object-cover" />
              ) : (
                <div className="text-center text-gray-400 p-4">
                  <Camera size={40} className="mx-auto mb-2" />
                  <p className="text-sm">Klik ambil foto</p>
                </div>
              )}
          ...
          <div>
            ...
            <div className="h-64 rounded-xl overflow-hidden border border-gray-200 z-0 relative">
              ...
              ) : <div className="h-full flex items-center justify-center bg-gray-100 text-gray-400">Loading GPS...</div>}
            </div>
          </div>
